...
// Menentukan tabel yang digunakan berdasarkan kategori yang dipilih
...
<head>
    <meta charset="utf-8">
    <title>AkastraRentCar - Service</title>
...
<a href="login.php" class="btn btn-book-now py-4 px-lg-5 d-lg-none">Reservation<i class="fa fa-arrow-right ms-3"></i></a>

    </div>
    <!-- Book Now button for large screens (still visible) -->
<a href="login.php" class="btn btn-book-now py-4 px-lg-5 d-none d-lg-block">Reservation<i class="fa fa-arrow-right ms-3"></i></a>
            ...
            <?php if ($result->num_rows > 0) : ?>
                ...
                <?php while ($row = $result->fetch_assoc()) : ?>
                    <tr>
                        ...
                        <td class="text-center"><a href="#" class="spec-link" onclick="showSpecifications('<?php echo $row['merk_mobil']; ?>', '<?php echo $row['jenis_mobil']; ?>', '<?php echo $row['transmisi']; ?>', '<?php echo $row['bahan_bakar']; ?>', '<?php echo $row['kapasitas_mesin']; ?>', '<?php echo $row['jumlah_bangku']; ?>', '<?php echo $row['gambar_mobil']; ?>')">Lihat Detail</a></td>
                    </tr>
                <?php endwhile; ?>
            <?php else : ?>
                <tr>
